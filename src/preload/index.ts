...
const api: TimeEfficiencyApi = {
  ...
  setWorkdayBoundary: (input) => ipcRenderer.invoke(IPC.setWorkdayBoundary, input),
  removeWorkdayBoundary: (input) => ipcRenderer.invoke(IPC.removeWorkdayBoundary, input),
  ...
  addIdleOverride: (input) => ipcRenderer.invoke(IPC.addIdleOverride, input),
  removeIdleOverride: (input) => ipcRenderer.invoke(IPC.removeIdleOverride, input),
