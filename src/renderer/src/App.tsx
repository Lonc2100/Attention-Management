...
export default function App() {
  ...
  return (
    <div className="shell">
      ...
      <main>
        {view !== 'today' && <header className="app-header">
          <div><p className="eyebrow">{data.date}</p><h1>{{ activities: '活动明细', insights: '个人规律', plan: '早间计划', review: '晚间复盘', diagnostics: '系统诊断', settings: '设置' }[view]}</h1></div>
